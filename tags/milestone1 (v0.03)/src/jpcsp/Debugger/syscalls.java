...
public class syscalls {
     static enum calls { 
		 ...
		 sceKernelDeleteThread(0x206e),
		 sceKernelStartThread(0x206f),
		 _sceKernelExitThread(0x2070),
		 sceKernelExitThread(0x2071),
		 sceKernelExitDeleteThread(0x2072),
		 sceKernelTerminateThread(0x2073),
		 ...
		 sceKernelReferThreadStatus(0x2080),
		 ...
		 sceKernelStdin(0x20b2),
		 sceKernelStdout(0x20b3),
		 sceKernelStderr(0x20b4),
		 ...
		 sceKernelUtilsMt19937Init(0x20bf),
		 ...
		 sceCtrlSetSamplingCycle(0x214c),
		 sceCtrlGetSamplingCycle(0x214d),
		 sceCtrlSetSamplingMode(0x214e),
		 sceCtrlGetSamplingMode(0x214f),
		 sceCtrlPeekBufferPositive(0x2150),
		 sceCtrlPeekBufferNegative(0x2151),
		 sceCtrlReadBufferPositive(0x2152),
		 sceCtrlReadBufferNegative(0x2153),
		 sceCtrlPeekLatch(0x2154),
		 sceCtrlReadLatch(0x2155),
