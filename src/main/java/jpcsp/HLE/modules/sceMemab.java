...
public class sceMemab extends HLEModule {
    ...
    public int sceMemab_F742F283(TPointer dataAddr, int dataLength, @BufferInfo(lengthInfo=LengthInfo.fixedLength, length=32, usage=Usage.out) TPointer outputAddr, boolean unknownFlag) {
