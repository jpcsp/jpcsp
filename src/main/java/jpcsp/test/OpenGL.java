...
//			    GL11.glPixelMapu(GL11.GL_PIXEL_MAP_I_TO_A, mapR);
		        GL11.glPixelMapfv(GL11.GL_PIXEL_MAP_I_TO_R, mapF);
		        System.out.println("Error: " + GL11.glGetError());
		        GL11.glPixelMapfv(GL11.GL_PIXEL_MAP_I_TO_G, mapF);
		        GL11.glPixelMapfv(GL11.GL_PIXEL_MAP_I_TO_B, mapF);
		        GL11.glPixelMapfv(GL11.GL_PIXEL_MAP_I_TO_A, mapF);
	        }
