...
/**
 * Base abstract class for a settings listener with integer value.
 * One of the "settingsValueChanged" method has to be overwritten by a concrete class.
 * 
 * @author gid15
 *
 */
public class AbstractIntSettingsListener extends AbstractStringSettingsListener {
	/* (non-Javadoc)
	...
	final public void settingsValueChanged(String option, String value) {
		settingsValueChanged(option, Settings.parseInt(value));
	}
	 ...
	 */
	protected void settingsValueChanged(String option, int value) {
	 ...
	 *     settingsValueChanged(String option, int value)
