...
import static jpcsp.util.Utilities.parseAddress;
...
public class DumpCodeDialog extends javax.swing.JDialog {
	...
	private static final long serialVersionUID = -3759593397311106839L;
    ...
    public int getStartAddress() {
        return parseAddress(txtStartAddress.getText());
    }

    public int getEndAddress() {
        return parseAddress(txtEndAddress.getText());
    }
    ...
    private class AddressInputVerifier extends InputVerifier {
        ...
        public boolean verify(JComponent input) {
            try {
                ...
                int value = parseAddress(tf.getText());
