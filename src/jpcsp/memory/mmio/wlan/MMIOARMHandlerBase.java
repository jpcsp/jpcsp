...
public class MMIOARMHandlerBase extends MMIOHandlerBase {
    ...
    private void invalidMemoryAddress(int address, String prefix, int status) {
        log.error(String.format("%s - Invalid memory address: 0x%08X PC=0x%08X", prefix, address, getPc()));
