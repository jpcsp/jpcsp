...
public class SysMemUserForUser extends jpcsp.HLE.modules150.SysMemUserForUser {
	...
	public void installModule(HLEModuleManager mm, int version) {
		...
		if (version >= 200) {
			...
			mm.addFunction(sceKernelGetCompiledSdkVersionFunction, 0xFC114573);
			mm.addFunction(sceKernelSetCompiledSdkVersionFunction, 0x7591C7DB);
			mm.addFunction(sceKernelSetCompilerVersionFunction, 0xF77D77CB);
			mm.addFunction(SysMemUserForUser_A6848DF8Function, 0xA6848DF8);
	...
	public void sceKernelGetCompiledSdkVersion(Processor processor) {
		...
		Modules.log.debug("Unimplemented NID function sceKernelGetCompiledSdkVersion [0xFC114573]");
	...
	public void sceKernelSetCompiledSdkVersion(Processor processor) {
		...
		Modules.log.debug("Unimplemented NID function sceKernelSetCompiledSdkVersion [0x7591C7DB]");
	...
	public void sceKernelSetCompilerVersion(Processor processor) {
		...
		Modules.log.debug("Unimplemented NID function sceKernelSetCompilerVersion [0xF77D77CB]");
	...
	public void SysMemUserForUser_A6848DF8(Processor processor) {
		...
		Modules.log.debug("Unimplemented NID function SysMemUserForUser_A6848DF8 [0xA6848DF8]");
