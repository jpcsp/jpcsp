...
public class LocalVirtualFileSystem extends VirtualFileSystem {
	...
	@Override
	public int ioIoctl(FileArg fileArg, int command, TPointer inputPointer,
			int inputLength, TPointer outputPointer, int outputLength) {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	@Override
	public int ioDevctl(FileArg fileArg, String deviceName, int command,
			TPointer inputPointer, int inputLength, TPointer outputPointer,
			int outputLength) {
		// TODO Auto-generated method stub
		return 0;
	}
