...
"%programfiles(x86)%\Java\jre6\bin\java" -Xmx512m -Djava.library.path=lib/windows-x86 -jar bin/jpcsp.jar
goto END

:JAVA32
if not exist "%programfiles%\Java\jre6\bin" goto JAVAMISSING
echo Running Jpcsp 32bit...
"%programfiles%\Java\jre6\bin\java" -Xmx512m -Djava.library.path=lib/windows-x86 -jar bin/jpcsp.jar
goto END
