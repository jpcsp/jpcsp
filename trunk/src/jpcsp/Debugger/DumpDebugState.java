...
public class DumpDebugState
{
    ...
    public static void dumpThreads()
    {
        ...
        for (Iterator<SceKernelThreadInfo> it = threadMan.iterator(); it.hasNext();)
        {
            ...
            log(String.format("Thread Wait Type: %s Us: %d Forever: %s InsideCallback: %b", getThreadWaitName(thread), thread.wait.micros, thread.wait.forever, thread.insideCallback));
