...
public class sceSysEventForKernel implements HLEModule {
	...
	public void sceKernelIsRegisterSysEventHandler(Processor processor) {
		...
		Modules.log.debug("Unimplemented NID function sceKernelIsRegisterSysEventHandler [0xAEB300AE]");
	...
	public void sceKernelRegisterSysEventHandler(Processor processor) {
		...
		Modules.log.debug("Unimplemented NID function sceKernelRegisterSysEventHandler [0xCD9E4BB5]");
	...
	public void sceKernelUnregisterSysEventHandler(Processor processor) {
		...
		Modules.log.debug("Unimplemented NID function sceKernelUnregisterSysEventHandler [0xD7D3FDCD]");
	...
	public void sceKernelSysEventDispatch(Processor processor) {
		...
		Modules.log.debug("Unimplemented NID function sceKernelSysEventDispatch [0x36331294]");
	...
	public void sceKernelReferSysEventHandler(Processor processor) {
		...
		Modules.log.debug("Unimplemented NID function sceKernelReferSysEventHandler [0x68D55505]");
