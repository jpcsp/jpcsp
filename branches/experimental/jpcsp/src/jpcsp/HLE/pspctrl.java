...
public class pspctrl {
    ...
    public void sceCtrlPeekBufferPositive(int a0, int a1)
    {
        ...
        PSPThread.currentPSPThread().processor.gpr[2] = i;
    }
