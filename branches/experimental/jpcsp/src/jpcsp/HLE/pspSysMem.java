...
public class pspSysMem {
    ...
    public void sceKernelMaxFreeMemSize()
    {
        ...
        PSPThread.currentPSPThread().processor.gpr[2] = maxFree;
    }
    ...
    public void sceKernelTotalFreeMemSize()
    {
        ...
        PSPThread.currentPSPThread().processor.gpr[2] = totalFree;
    }
    ...
    public void sceKernelGetBlockHeadAddr(int uid) throws GeneralJpcspException
    {
        ...
        if (info == null) {
            ...
            PSPThread.currentPSPThread().processor.gpr[2] = info.addr;
        }
    }
    ...
    public void sceKernelDevkitVersion()
    {
        ...
        PSPThread.currentPSPThread().processor.gpr[2] = 0x01050100;
    }
