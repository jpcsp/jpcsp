...
public class Memory {
    ...
    private static byte[]     all; // all psp memory is held in here
    private static int[]      map; // hold map of memory
    private static ByteBuffer buf; // for easier memory reads/writes
    ...
    public static int indexFromAddr(int address) throws Exception {
        ...
        if (index == -1) {
        	PSPThread thread = PSPThread.currentPSPThread();
            throw new Exception(
                    "Invalid memory address : " +
                    Integer.toHexString(address) +
                    " PC=" +
                    Integer.toHexString(thread.processor.pc) + " Thread=" + thread.getName());
        }
        return index;
    }
    ...
    public static int read8(int page, int address) {
        try {
            return (int)buf.get(page + (address & PAGE_MASK)) & 0xFF;
        } catch (Exception e) {
            System.out.println("read8 - " + e.getMessage());
    ...
    public static int read16(int page, int address) {
        try {
            return (int)buf.getShort(page + (address & PAGE_MASK)) & 0xFFFF;
        } catch (Exception e) {
            System.out.println("read16 - " + e.getMessage());
    ...
    public static int read32(int page, int address) {
        try {
            return buf.getInt(page + (address & PAGE_MASK));
        } catch (Exception e) {
            System.out.println("read32 - " + e.getMessage());
    ...
    public static void write8(int address, byte data) {
        try {
            int page = indexFromAddr(address);
            buf.put(page + (address & PAGE_MASK), data);
            pspdisplay.get_instance().write8(address, data);
            //System.err.println("write8 0x" + Integer.toHexString(address));
        } catch (Exception e) {
    ...
    public static void write8(int page, int address, byte data) {
        try {
            buf.put(page + (address & PAGE_MASK), data);
            pspdisplay.get_instance().write8(address, data);
            //System.err.println("write8 0x" + Integer.toHexString(address));
    ...
    public static void write16(int address, short data) {
        try {
            int page = indexFromAddr(address);
            buf.putShort(page + (address & PAGE_MASK), data);
            pspdisplay.get_instance().write16(address, data);
           // System.err.println("write16 0x" + Integer.toHexString(address));            
        } catch (Exception e) {
    ...
    public static void write16(int page, int address, short data) {
        try {
            buf.putShort(page + (address & PAGE_MASK), data);
            pspdisplay.get_instance().write16(address, data);
        } catch (Exception e) {
    ...
    public static void write32(int address, int data) {
        try {
            int page = indexFromAddr(address);
    ...
    public static void write32(int page, int address, int data) {
        try {
            buf.putInt(page + (address & PAGE_MASK), data);
           pspdisplay.get_instance().write32(address, data);
        } catch (Exception e) {
    ...
    public static void write64(int address, long data) {
        try {
            int page = indexFromAddr(address);
    ...
    public static void write64(int page, int address, long data) {
        try {
            buf.putLong(page + (address & PAGE_MASK), data);
            //pspdisplay.get_instance().write64(address, data);
        } catch (Exception e) {
